...
wget -O /etc/apache2/ports.conf https://raw.githubusercontent.com/buttacuore2/vpn/main/data/apache2.port
...
wget -O /var/www/html/index.html https://raw.githubusercontent.com/buttacuore2/vpn/main/data/index.html
sudo systemctl restart apache2
clear
